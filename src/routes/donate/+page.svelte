...
<main class="container w-screen">
	<article>
		...
		<p class="p-4 text-left mx-auto w-full">
			Ce site est gratuit à utiliser pour tout le monde mais coûte du temps de de l'argent pour maintenir de ma
			part. Si vous trouvez ce site web utile, pensez à faire un don pour aider à sa maintenance et
			son développement.
		</p>
